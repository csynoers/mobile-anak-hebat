    ...
    <script src="<?= base_url() ?>/bootstrap/dist/js/bootstrap.min.js" integrity="sha384-OgVRvuATP1z7JjHLkuOU7Xw704+h835Lr+6QL9UvYjZE3Ipu6Tp75j7Bh/kR0JKI" crossorigin="anonymous"></script>
    <!-- Owl Carousel -->
    <script src="<?= base_url() ?>/owl/dist/owl.carousel.min.js"></script>
    <!-- Custom -->
    <script src="<?= base_url() ?>/custom/scm-custom.js"></script>
  </body>
</html>