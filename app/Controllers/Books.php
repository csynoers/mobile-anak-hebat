        ...
        foreach ($rows as $key => $value) {
            $rows_all['rows'][] = [
                ...
                'image'             => [
                    ...
                    'thumbnail' => file_exists("https://anakhebatindonesia.com/joimg/book/small/small_{$value['image']}") ? "https://anakhebatindonesia.com/joimg/book/small/small_{$value['image']}" : "https://via.placeholder.com/100.png?text=no thumbnail",
                ],
                'stok'              => $value['stok'],
                'price'             => [
                    'idr' => [
